...
structured REFUSE message. The caller (scripts/last30days-curated.py main()) writes
...
def _refuse_message(topic: str) -> str:
    return (
        f'[last30days-curated] The topic "{topic}" is too broad for useful recent-source retrieval.\n'
        "\n"
