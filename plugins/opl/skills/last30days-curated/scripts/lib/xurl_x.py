"""X search through the xurl CLI and official X API v2 OAuth2.
...
The runtime X backend chain determines xurl's priority.
"""
...
def is_available() -> bool:
    ...
    The result is memoized for the current process.
    """
...
# Credential markers in the xurl token store.
