...
ENDPOINT_OVERRIDE_KEYS = {
    "LAST30DAYS_CURATED_SEARXNG_URL",
    "LAST30DAYS_CURATED_YOUTUBE_SSH_HOST",
    "OPENAI_BASE_URL",
    "XAI_BASE_URL",
}
...
def build(
    ...
    *,
    ...
    if ignored_project_config:
        action_items.append("Project config was ignored; set LAST30DAYS_CURATED_TRUST_PROJECT_CONFIG=1 to trust it.")
...
def render_text(preflight: dict[str, Any]) -> str:
    ...
    lines: list[str] = ["last30days-curated preflight"]
