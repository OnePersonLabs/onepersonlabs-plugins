...
#
# SOCIAL_NOISE: short social posts where research/meta words rarely appear in
# the body.
...
# VIRAL_NOISE: TikTok and YouTube. Adds 'killer', the prompt-meta cluster, and the
...
def infer_query_intent(topic: str) -> str:
    ...
    ``fix``). Adapters use this shared superset.
...
def extract_compound_terms(topic: str) -> List[str]:
    ...
    - Title-cased multi-word names: "Visual Studio Code", "React Native"
