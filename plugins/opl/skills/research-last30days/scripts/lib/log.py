"""Shared logging utilities for research-last30days skill."""

import os
import sys

DEBUG = os.environ.get("RESEARCH_LAST30DAYS_DEBUG", "").lower() in ("1", "true", "yes")


def debug(msg: str) -> None:
    """Log debug message to stderr (only when RESEARCH_LAST30DAYS_DEBUG is set)."""
    if DEBUG:
