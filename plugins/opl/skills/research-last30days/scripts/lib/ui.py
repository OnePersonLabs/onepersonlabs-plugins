...
class ProgressDisplay:
    ...
    def start_processing(self) -> None:
        sys.stderr.write(f"[research-last30days] Researching: {self.topic}\n")
        sys.stderr.flush()
    ...
    def show_complete(
        ...
        *,
        ...
        sys.stderr.write(f"[research-last30days] Retrieval complete: {summary}\n")
        sys.stderr.flush()

    def show_error(self, message: str) -> None:
        self.end_processing()
        sys.stderr.write(f"[research-last30days] Error: {message}\n")
        sys.stderr.flush()
