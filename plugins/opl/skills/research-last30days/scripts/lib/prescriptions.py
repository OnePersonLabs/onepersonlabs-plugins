...
_ENGINE = Path(__file__).resolve().parents[1] / "research-last30days.py"
ENGINE_CLI = f"{shlex.quote(sys.executable)} {shlex.quote(str(_ENGINE))}"
EDIT_CONFIG_CLI = '${EDITOR:-vi} "$HOME/.config/research-last30days/.env"'
...
REGISTRY: Dict[Tuple[str, str], Prescription] = dict((
    _entry(
        ...
        fix_nl=(
            ...
            "into x.com and set RESEARCH_LAST30DAYS_FROM_BROWSER to the browser "
