...
ENDPOINT_OVERRIDE_KEYS = {
    "RESEARCH_LAST30DAYS_SEARXNG_URL",
    "RESEARCH_LAST30DAYS_YOUTUBE_SSH_HOST",
    "OPENAI_BASE_URL",
    "XAI_BASE_URL",
}
...
def build(
    ...
    *,
    ...
    if ignored_project_config:
        action_items.append("Project config was ignored; set RESEARCH_LAST30DAYS_TRUST_PROJECT_CONFIG=1 to trust it.")
    ...
    return {
        ...
        "local_reads": {
            ...
            "configuration": dict(config.get("_CONFIG_LOCAL_READS") or {}),
            "project_config": {
...
def render_text(preflight: dict[str, Any]) -> str:
    ...
    lines: list[str] = ["research-last30days preflight"]
