...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, using `$test-driven-development-curated` and closing out with `/code-review` before committing.
