---
name: "openspec-x-dependency-audit"
...
```bash
node .agents/skills/openspec-x-dependency-audit/scripts/opsxx-deps.mjs --audit
```
...
```bash
node .agents/skills/openspec-x-dependency-audit/scripts/opsxx-deps.mjs --audit --json
```
