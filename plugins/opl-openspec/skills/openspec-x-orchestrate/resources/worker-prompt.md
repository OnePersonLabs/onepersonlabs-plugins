...
Implement only that change with `$openspec-apply-change $CHANGE-NAME`, run focused checks for touched surfaces, and commit the branch with the change name in the message.
